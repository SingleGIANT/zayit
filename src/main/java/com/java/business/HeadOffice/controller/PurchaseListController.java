...
public class PurchaseListController {
	...
	// public Iterable<PurchaseList> getUser() {
	// 	return service.listAll();

	// }

	// @PostMapping(value = "/purchaselist/save")
	// private long saveBook(@RequestBody PurchaseList purchase) {
	// 	service.save(purchase);
	// 	return purchase.getPurchase_list_id();
	// }
...
return ResponseEntity.status(HttpStatus.INTERNAL_SERVER_ERROR).body("Error retrieving PurchaseLists: " + e.getMessage());
...
return ResponseEntity.status(HttpStatus.INTERNAL_SERVER_ERROR).body("Error saving PurchaseList: " + e.getMessage());
