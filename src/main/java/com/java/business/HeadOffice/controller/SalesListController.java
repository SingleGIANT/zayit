...
public class SalesListController {
	...
	// public Iterable<SalesList> getUser() {
	// 	return service.listAll();

	// }

	// @PostMapping(value = "/saleslist/save")
	// private long saveBook(@RequestBody SalesList sales) {
		
	// 	service.save(sales);
	// 	return sales.getSaleslist_id();
...
return ResponseEntity.status(HttpStatus.INTERNAL_SERVER_ERROR).body("Error saving saleslist: " + e.getMessage());
